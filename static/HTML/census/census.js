...
let census_div_settings=[
    ...
    {id:'screen_title',l:'10',t:12,w:'80',h:'15',b_i:'http://172.16.10.35:8000/static/HTML/census/title.png'},
...
function census_success(data) {
    ...
    for(let level=0;level<15;level++)
    {
        ...
        div_init([{id:`level_${level}`,l:5,t:level*5.8,w:60,h:5,b:'#000000',b_c:'#fff4d8',o:2},], r = rule);
